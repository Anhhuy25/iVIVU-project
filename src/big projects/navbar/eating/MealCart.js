                    ...
                    <div key={item.id} className="mealcart-detail">
                      ...
                      <div className="mealcart-remainpart">
                        <div className="mealcart-price">
                          <span className="mealcart-pricenum">
                        ...
                        <div className="mealcart-quantity">
                          ...
                          <span className="mealcart-quantitynum">
                            {item.quantity}
                          </span>
                          <button onClick={() => incItem(item.id)}>+</button>
                        </div>
                        <span
                          className="mealcart-removebtn"
            ...
            <div className="col l-3 m-12 c-12">
              <div className="mealcart-orderprocess">
                <div className="mealcart-total">
                  <p>Thành tiền:</p>
                  <p>
                    <span className="mealcart-totalprice">
                      {total.toLocaleString()}
                    </span>
                    <span> đ/tuần</span>
                  </p>
                </div>
                <button className="mealcart-orderbtn">
                  Tiến hàng đặt hàng
                </button>
              </div>
              ...
              <div className="mealcart-delivery">
                <p>
                  Giao hàng miễn phí bữa trưa (11h15 - 12h00), bữa tối (16h00 -
                  17h00) hàng ngày tại các khu vực:
                </p>
                <p>
                  - Hồ Chí Minh: Quận 1, Quận 10, Quận 11, Quận 2, Quận 3, Quận
                  4, Quận 5, Quận 6, Quận 7, Quận 8, Quận Bình Thạnh, Quận Gò
                  Vấp, Quận Phú Nhuận, Quận Tân Bình, Quận Tân Phú.
                </p>
                <p>
