...
const LunchList = () => {
  const {
    tasteMeal, setTasteMeal, cookMeal, setCookMeal, priceMeal, setPriceMeal,
    tasteValue, setTasteValue, cookValue, setCookValue, priceValue, setPriceValue,
  } = useGlobalContext();
                  ...
                  <div className="meal-taste">
                    ...
                    <div className="meal-tastelist">
                      <div className="meal-tasteitem">
                        <input type="radio" name="taste" id="north" value="Vị Bắc"
                          onChange={changeTasteValue}
                        />
                        <label htmlFor="north">Vị Bắc</label>
                      </div>
                      <div className="meal-tasteitem">
                        <input type="radio" name="taste" id="central" value="Vị Trung"
                          onChange={changeTasteValue}
                        />
                        <label htmlFor="central">Vị Trung</label>
                      </div>
                      <div className="meal-tasteitem">
                        <input type="radio" name="taste" id="south" value="Vị Nam"
                          onChange={changeTasteValue}
                        />
                        <label htmlFor="south">Vị Nam</label>
                      </div>
                      <div className="meal-tasteitem">
                        <input type="radio" name="taste" id="all" value="Collection"
                          onChange={changeTasteValue}
                        />
                  ...
                  <div className="meal-cook">
                    ...
                    <div className="meal-cooklist">
                      <div className="meal-cookitem">
                        <input type="radio" name="cook" id="frugal" value="Thanh đạm"
                          onChange={changeCookValue}
                        />
                        <label htmlFor="frugal">Thanh đạm</label>
                      </div>
                      <div className="meal-cookitem">
                        <input type="radio" name="cook" id="warm" value="Đậm đà"
                          onChange={changeCookValue}
                        />
                  ...
                  <div className="meal-priceselect">
                    ...
                    <div className="meal-pricelist">
                      <div className="meal-priceitem">
                        <input type="radio" name="price" id="199" value="199.000đ/tuần"
                          onChange={changePriceValue}
                        />
                        <label htmlFor="199">199.000đ/tuần</label>
                      </div>
                      <div className="meal-priceitem">
                        <input type="radio" name="price" id="299" value="299.000đ/tuần"
                          onChange={changePriceValue}
                        />
                        <label htmlFor="299">299.000đ/tuần</label>
                      </div>
                      <div className="meal-priceitem">
                        <input type="radio" name="price" id="399" value="399.000đ/tuần"
                          onChange={changePriceValue}
                        />
