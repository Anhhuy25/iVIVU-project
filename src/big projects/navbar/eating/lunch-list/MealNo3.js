...
const MealNo3 = () => {
  ...
  useEffect(() => {
    const mealChoose = filterMeal.find(
      (meal) => meal.to === "bua-trua-dam-da-vi-bac-standard"
    );
                ...
                <div className="row">
                  <div className="col l-6 m-12 c-12">
                    <div className="lunchlist-whychoose">
                      ...
                      <p>
                        Bạn sẽ được thưởng thức những món ngon chuẩn vị Bắc, ít
                        dầu mỡ như: Trứng đúc hẹ, cá basa kho tiêu, mướp đắng
                        xào thịt, cá quả kho nghệ… ăn kèm với món canh su hào
                        nấu thịt, canh cá nấu măng, canh cải xanh gừng thịt,
                        canh bí đỏ nấu thịt, canh cải thảo nấu thịt...
                      </p>
                      <p>
                        Nổi bật trong thực đơn ăn trưa tuần này là món là gà
                        rang gừng với sự kết hợp hoàn hảo giữa thịt gà mềm thơm,
                        đậm đà hòa quyện với vị cay cay, nồng nồng của gừng cực
                        kỳ đưa cơm, cung cấp nhiều protein mang đến cho bạn bữa
                        ăn trưa bổ dưỡng.
                      </p>
                      <p>
                        Ngoài ra bữa trưa cũng không thể thiếu những món rau
                        thanh mát được đổi vị mỗi ngày: Rau cải xoong xào tỏi,
                        bầu xào nghêu, bầu luộc,… mang đến bữa trưa ngon miệng.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="col l-6 m-12 c-12">
                    <div className="lunchlist-designed">
                      ...
                      <p className="lunclist-chefdesc">
                        Chu Anh Tiệp Với kinh nghiệm 15 năm trong nghề, từng làm
                        ở nhiều khách sạn 5 sao quốc tế như: InterContinental
                        Hanoi Westlake, Mövenpick Hotel Hanoi... đầu bếp Chu Anh
                        Tiệp có sở trường về những món Âu, Á và đặc biệt là
                        những đặc sản vùng miền. Chắc chắn thực đơn do đầu bếp
                        Chu Anh Tiệp thiết kế sẽ mang đến cho thực khách những
                        món chuẩn vị miền Bắc thanh tao, tròn vị kèm những biến
                        tấu đặc biệt.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="lunchlist-pickdayform">
                      ...
                      <div>
                        ...
                        <label htmlFor="monday">
                          ...
                          <p>
                            · Rau cải xoong xào tỏi · Canh cải thảo nấu thịt
                          </p>
                        </label>
                      </div>
                      <div>
