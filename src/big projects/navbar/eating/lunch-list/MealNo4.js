...
const MealNo4 = () => {
  ...
  useEffect(() => {
    const mealChoose = filterMeal.find(
      (meal) => meal.to === "bua-trua-thanh-dam-vi-nam-standard"
    );
                ...
                <div className="row">
                  <div className="col l-6 m-12 c-12">
                    <div className="lunchlist-whychoose">
                      ...
                      <p>
                        Nổi bật trong tuần này là món chả cá kho cà hấp dẫn.
                        Thịt chả cá dai ngon hòa quyện với sốt cà chua đậm đà ăn
                        kèm với cơm nóng thì ngon còn gì bằng. Các ngày còn lại,
                        bạn sẽ được đổi vị với các món chính như: Trứng cút sốt
                        chua ngọt, cá diêu hồng nướng sả, gà luộc, thịt viên sốt
                        nấm... được chế biến để giữ trọn vẹn hương vị tươi ngon
                        nhất của thực phẩm.
                      </p>
                      <p>
                        Bạn cũng sẽ ưng ý với món canh gà nấm. Món canh với nước
                        dùng gà ngọt thanh kết hợp với vị ngọt của nấm ăn vừa
                        thanh mát, vừa tốt cho sức khỏe.
                      </p>
                    </div>
                  </div>
