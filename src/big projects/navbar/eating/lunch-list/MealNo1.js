...
const MealNo1 = () => {
  ...
  useEffect(() => {
    const mealChoose = filterMeal.find(
      (meal) => meal.to === "bua-trua-dam-da-vi-nam-standard"
    );
                ...
                <div className="row">
                  <div className="col l-6 m-12 c-12">
                    <div className="lunchlist-whychoose">
                      ...
                      <p>
                        Cá saba kho cà chuẩn vị miền Nam trong thực đơn tuần này
                        chắc chắn khiến bạn hài lòng, với phần cá được nêm nếm
                        vừa ăn, cộng thêm chút chua rất kích thích vị giác của
                        cà.
                      </p>
                      <p>
                        Món mặn tuần này còn có vịt kho gừng, lòng xào cải chua,
                        thịt kho thơm, gà nướng mè được dùng kèm những món phụ
                        không kém phần hấp dẫn như rau luộc, rau sống, dưa leo,
                        đậu hũ chiên sả, cải thảo xào tỏi, xà lách dầu giấm.
                      </p>
                      <p>
                        Ngoài ra, mỗi bữa trưa còn có nhiều món canh bổ dưỡng
                        giúp bữa trưa thêm tròn vị, gồm: Canh cải thảo nấu thịt,
                        canh bắp cải nấu thịt, canh cải thảo nấu thịt, canh
                        khoai mỡ nấu thịt, canh đu đủ nấu thịt.
                      </p>
                    </div>
                  </div>
