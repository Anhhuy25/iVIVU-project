...
const SGHNSPHL5N4D = () => {
  ...
  const {
    ...
    showTableDay2403, setShowTable2403, numberAdult, setNumberAdult,
    numberChildren, setNumberChildren, requireOrWatch, setRequireOrWatch,
    showPriceAndTotal, setShowPriceAndTotal, showPriceChildren, setShowPriceChildren,
    listAge, selectAge, setSelectAge, showSingleRoom, setShowSingleRoom,
            ...
            <div className="col l-8 m-12 c-12">
              <div className="tourtet-content">
                ...
                <div className="tourtet-info">
                  ...
                  <span className="tourtet-code">Mã Tour: <b>TO1257</b></span>
                </div>
                <div className="tourtet-description">
                  ...
                  <div id="2" className="tourtet-tailortour"><TailorTour /></div>
                      ...
                      {!showTableDay1403 && (
                        <div className="tourtet-departureschedule-table-adultchildren">
                          <div className="tourtet-departureschedule-tableadult">
                            ...
                            {showPriceAndTotal && <span className="tourtet-departureschedule-price">x {price.toLocaleString()}</span>}
                  ...
                  <div className="tourtet-expensepolicy">
                    ...
                    <div className="tourtet-expensepolicy-list">
                      <p>- Phụ Thu phòng đơn : 1.350.000 vnđ/khách/phòng. Dịp Lễ Tết phụ thu: 1.600.000 vnđ/khách/tour. </p>
                      <p>- Trẻ em từ 10 tuổi trở lên mua 01 vé bằng giá tour người lớn.</p>
                      <p>- Trẻ em dưới 02 tuổi, được miễn phí tour và phụ thu vé máy bay theo quy định của hãng hàng không.</p>
                      <p>- Trẻ em từ 02 tuổi dưới 05 tuổi, được miễn phí tour vé máy bay theo quy định của hãng hàng không Viet Jet Air ( 100% giá vé máy bay người lớn) , người thân đi kèm tự lo các chi phí ăn, ngủ, tham quan (nếu có) cho bé. Hai người lớn chỉ kèm 1 trẻ em dưới 5 tuổi, trẻ em thứ 2 trở lên phải mua ½ vé tour.</p>
                      <p>- Trẻ em từ 05 tuổi dưới 10 tuổi, tính 50% giá tour và 100% vé máy bay theo quy định của hãng hàng không Viet Jet Air . Bao gồm các dịch vụ ăn uống, ghế ngồi trên xe và ngủ chung với gia đình. Hai người lớn chỉ được kèm 1 trẻ em, trẻ em thứ 2 trở lên, mua thêm 1 suất giường đơn hoặc 1 vé người lớn.</p>
                    </div>
                  </div>
                  ...
                  <div className="tourtet-terms">
                    ...
                    <div className="tourtet-terms-list">
                      <span onClick={handleChangeTerm1} className={`${firstTerm ? 'tourtet-terms-active' : ''} tourtet-firstterm`}>Bao Gồm</span>
                      <span onClick={handleChangeTerm2} className={`${secondTerm ? 'tourtet-terms-active' : ''} tourtet-secondterm`}>Không Bao Gồm</span>
                      <span onClick={handleChangeTerm3} className={`${thirdTerm ? 'tourtet-terms-active' : ''} tourtet-thirdterm`}>Hủy Đổi</span>
                      <span onClick={handleChangeTerm4} className={`${fourthTerm ? 'tourtet-terms-active' : ''} tourtet-fourthterm`}>Lưu ý</span>
                      {firstTerm && (
                        <div className="tourtet-firstterm-list">
                          <div>
                            <u>Vận chuyển:</u>
                            <p>- Xe tham quan (16, 29, 35, 45 chỗ tùy theo số lượng) đón - tiễn và phục vụ theo chương trình.</p>
                          ...
                          <div>
                            ...
                            <p>- Để xác nhận việc lấy hóa đơn đỏ VAT, Quý khách phải cung cấp thông tin ngay khi đăng ký.</p>
                      ...
                      {thirdTerm && (
                        <div className="tourtet-thirdterm-list">
                          <b>Chính sách hủy:</b>
                          <p>Mọi sự thay đổi liên quan đến vé đã xuất: ngày giờ đi, tên hành khách, hủy vé, vui lòng chịu chi phí theo qui định sau:</p>
                          <p>- Ngay sau khi đăng ký tour nếu hủy sẽ bị phạt tiền tour và vé máy bay: </p>
                          <p>- Ngay sau khi đặt cọc hoặc thanh toán hoặc trước 15 ngày: phí hủy 10% tiền tour + 100% Vé máy bay.</p>
                          ...
                          <p>- Quý khách có mặt trước giờ bay 120 tại điểm hẹn, trường hợp quý khách đến trễ giờ khởi hành, được tính là hủy 5 ngày trước ngày khởi hành.</p>
                          <p>- Do tính chất là đoàn ghép khách lẻ,công ty sẽ có trách nhiệm nhận khách đăng ký cho đủ đoàn ( trên 10 người lớn) thì đoàn sẽ khởi hành đúng lịch trình. Nếu số lượng đoàn dưới 10 khách, công ty có trách nhiệm thông báo cho khách trước ngày khởi hành 3 ngày và sẽ thỏa thuận lại ngày khởi hành mới hoặc hoàn trả toàn bộ số tiền đã đặt cọc tour.</p>
                          <p>- Việc huỷ bỏ chuyến đi phải được thông báo trực tiếp với Công ty hoặc qua fax, email, tin nhắn và phải được Công ty xác nhận. Việc huỷ bỏ bằng điện thoại không được chấp nhận.</p>
                          <p>- Đối với sự thay đổi lịch trình, giờ bay do lỗi của hãng hàng không, tàu hoả, tàu thuỷ, công ty sẽ không chịu trách nhiệm bất kỳ phát sinh nào do lỗi trên như: phát sinh bữa ăn, nhà hàng, khách sạn, phương tiện di chuyển, hướng dẫn viên...</p>
                        </div>
                      )}
                      {fourthTerm && (
                        <div className="tourtet-fourthterm-list">
                          ...
                          <p>- Khi Quý khách đăng kí tour, xác nhận sự chính xác về họ, tên (đúng từng ký tự ghi trong hộ chiếu hoặc CMND), ngày-tháng-năm sinh... của hành khách theo yêu cầu của hãng vận chuyển.</p>
                          <p>- Do đặc điểm địa hình, tại Sapa quý khách chủ yếu đi bộ để tham quan, vì thế quý khách vui lòng lựa chọn trang phục phù hợp.</p>
                          <p>- Quý khách trên 70 tuổi hoặc phụ nữ có Thai dưới 06 Tháng (Vì lý do sức khỏe của Thai phụ, chúng tôi từ chối cung cấp dịch vụ tour cho Phụ nữ mang thai trên 06 tháng) khi đi phải có giấy xác nhận đảm bảo sức khỏe của Bệnh viện cấp Quận/ Huyện trở lên.</p>
                          <p>- Khi đi du lịch Quý khách dưới 14 tuổi mang theo giấy khai sinh bản chính hoặc hộ chiếu còn hạn, Trên  14 tuổi phải đem theo giấy CMND, Hộ Chiếu, CCCD bản chính, hình ảnh rõ, còn hạn sử dụng trong vòng 15 năm kể từ ngày cấp hoặc Hộ Chiếu còn hạn.</p>
                          <p>- Riêng khách Việt Kiều phải mang theo Hộ Chiếu hoặc thẻ xanh kèm theo Visa và giấy tái xuất nhập Việt Nam làm thủ tục lên máy bay.</p>
                          <p>- Hành lý sách tay: Tối đa 07 ký xách tay /khách, không để các vật dụng sắc nhọn, chất dễ cháy.</p>
                          <p>- Hành lý ký gửi: tối đa 20kg /khách, không để máy chụp ảnh, máy tính sách tay, tư trang, tiền bạc có giá trị vào hành lý ký gửi.</p>
                        </div>
                      )}
                ...
                <div className="tourtet-totalprice">
                  ...
                  <div className="tourtet-totalprice-adult">
                    ...
                    <div className="tourtet-totalprice-adultpricequantity">
                      {showPriceAndTotal && <span className="tourtet-totalprice-adultprice">x {price.toLocaleString()}</span>}
