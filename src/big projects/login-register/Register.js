        ...
        <div className="input-register">
          <div className="input-name">
            ...
            {checkName ? (
              ...
              <p className="error-name">Vui lòng điền vào trường này</p>
            )}
            {checkAfterAt ? (
              ""
            ) : (
          ...
          <div className="input-password">
            ...
            {checkPassword ? (
              ...
              <p
                className={`${
                  showErrorMess
                    ? "error-password-regis"
                    : "error-password-regis-sub"
                }`}
              >
          ...
          <div className="input-repassword">
            ...
            {checkRePassword ? (
              ...
              <p
                className={`${
                  showErrorMess ? "error-repassword" : "error-repassword-sub"
                }`}
              >
                Vui lòng điền vào trường này
              </p>
            ...
            {showErrorMess ? (
              ...
              <p className="error-checkbox">
                Bạn phải đồng ý điều khoản của iVIVU!
              </p>
            )}
          </div>
          ...
          <div className="input-checkbox">
            ...
            <label htmlFor="check">
              ...
              <Link target="_blank" to="/dieu-kien-dieu-khoan/">
                {" "}
                điều kiện va điều khoản.
              </Link>
            </label>
          </div>
        </div>
