      ...
      <div className="grid wide">
        <div className="row">
          <div className="col l-12 m-12 c-12">
            <h1 className="domestic-tourism-title">
              Điểm đến yêu thích trong nước
            </h1>
            <p className="domestic-tourism-description">
            ...
            <div className="domestic-tourism-top">
              <div className="domestic-tourism-top-left">
                <div className="domestic-tourism-top-left-up">
                  <Link to="" className="domestic-tourism-link-top-left">
                    <img
                      src={phuquoc}
                      alt="phuquoc"
                      className="domestic-phuquoc-img"
                    />
                  ...
                  <div className="domestic-nhatrang">
                    <Link to="" className="domestic-tourism-link-top-left">
                      <img
                        src={nhatrang}
                        alt="nhatrang"
                        className="domestic-nhatrang-img"
                      />
                      <div className="domestic-tourism-info-top">
                        <h1>Nha Trang</h1>
                        <p>112 khách sạn</p>
                  ...
                  <div className="domestic-quynhon">
                    <Link to="" className="domestic-tourism-link-top-left">
                      <img
                        src={quynhon}
                        alt="quynhon"
                        className="domestic-quynhon-img"
                      />
                      <div className="domestic-tourism-info-top">
                        <h1>Quy Nhơn</h1>
                        <p>112 khách sạn</p>
              ...
              <div className="domestic-tourism-top-right">
                <Link to="" className="domestic-tourism-link-top-right">
                  <img
                    src={vungtau}
                    alt="vungtau"
                    className="domestic-vungtau-img"
                  />
                  <div className="domestic-tourism-info-top">
                    <h1>Vũng Tàu</h1>
                    <p>99 khách sạn</p>
            ...
            <div className="domestic-tourism-bottom">
              <div className="domestic-tourism-bottom-left">
                <Link to="" className="domestic-tourism-link-bottom-left">
                  <img
                    src={danang}
                    alt="danang"
                    className="domestic-danang-img"
                  />
              ...
              <div className="domestic-tourism-bottom-right">
                <div className="domestic-tourism-bottom-right-up">
                  <Link to="" className="domestic-tourism-link-bottom-right">
                    <img
                      src={dalat}
                      alt="dalat"
                      className="domestic-dalat-img"
                    />
                    <div className="domestic-tourism-info-bottom">
                      <h1>Đà Lạt</h1>
                      <p>145 khách sạn</p>
                  ...
                  <div className="domestic-phanthiet">
                    <Link to="" className="domestic-tourism-link-bottom-right">
                      <img
                        src={phanthiet}
                        alt="phanthiet"
                        className="domestic-phanthiet-img"
                      />
                      <div className="domestic-tourism-info-bottom">
                        <h1>Phan Thiết</h1>
                        <p>93 khách sạn</p>
